...
if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {
    ...
    if (isset($_POST['userId'])) {
        ...
        $sql = "UPDATE tbl_donor SET safe_life_date='$crntDate' WHERE donor_id='$userId' ";
    ...
    <div class="container" style="padding: 60px 0;">
        <div class="row">
            <div class="col-md-12 col-md-push-1">
                <div class="panel panel-default" style="padding: 20px;">
                    <div class="panel-body">
                        ...
                        <div class="heading text-center">
                            ...
                            <h3>Welcome </h3> <h1><?php if (isset($_SESSION['donor_name'])) echo $_SESSION['donor_name']; ?></h1>
                        </div>
				...
				<button type="submit" style="margin-top: 20px;" name="date" id="save_the_life" class="btn btn-lg btn-danger center-aligned ">Save The Life</button>
				</form>';
                        } else {
				...
				<span>You already safe the life. You will donate the blood after three months. We are very thank full to you.</span>
                                </div>";
                            }
                        }
                        ?>
